...
fix_sandbox(){
  log "Checking Chrome sandbox requirements..."
  ...
  # -----------------------------------------------------------------------
  # Preferred approach: unprivileged user namespaces (kernel 6.2+ / Landlock
  # v3). When enabled system-wide, Chromium/Electron can sandbox itself with
